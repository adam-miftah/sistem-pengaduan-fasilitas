...
@section('content')
  <div class="container-fluid px-4 py-3">
    <div class="d-flex align-items-center justify-content-between my-2">
      <div>
        <h4 class="fw-bold mb-0 text-dark">Edit Data Petugas</h4>
        <small class="text-muted">Perbarui informasi akun dan profil petugas.</small>
      </div>
    </div>
      ...
      <div class="card-body p-4">
        <form action="{{ route('admin.petugas.update', $petugas->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label fw-semibold text-secondary small text-uppercase">Password Baru</label>
                <div class="input-group">
                  <span class="input-group-text bg-light border-end-0 text-muted">
                ...
                <div class="form-text small ms-1 text-muted">Hanya isi jika ingin mereset password petugas ini.</div>
                @error('password')
                  <div class="text-danger small mt-1">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="d-flex align-items-center gap-4">
              @if($petugas->photo)
                <div class="text-center">
                  <img src="{{ asset('storage/' . $petugas->photo) }}" class="rounded-3 border shadow-sm object-fit-cover"
              ...
              <div class="flex-grow-1">
                ...
                <div class="form-text small ms-1">Upload foto baru untuk mengganti. Format: JPG, JPEG, PNG (Max 2MB).
                </div>
                @error('photo')
                  <div class="text-danger small mt-1">{{ $message }}</div>
                @enderror
