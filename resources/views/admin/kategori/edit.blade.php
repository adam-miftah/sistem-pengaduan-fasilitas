  ...
  <div class="container-fluid px-4 mt-2">
    <div class="d-flex align-items-center justify-content-between my-4">
      <div>
        ...
        <small class="text-muted">Perbarui informasi kategori fasilitas yang sudah ada.</small>
      </div>
    </div>
              ...
              <div class="mb-4">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="nama_kategori" name="nama_kategori"
                    ...
                    value="{{ old('nama_kategori', $kategori->nama_kategori) }}" placeholder="Masukan nama kategori..."
                    required>
                ...
                <div class="form-text small text-muted mt-1 ms-1">
                  Perubahan nama kategori akan berlaku untuk semua data terkait.
                </div>
              </div>
